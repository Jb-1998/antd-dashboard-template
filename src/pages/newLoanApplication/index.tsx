...
import { Layout, Menu, Breadcrumb,  Table, Space, Button, Input, Drawer, Form,Col, Row, Select, DatePicker, Tabs} from 'antd';
import {FileSearchOutlined,SaveOutlined,ReloadOutlined } from '@ant-design/icons';
...
const NewLoanApplication: FC<BaseProps> = () => {
    ...
    return  (
        ...
        <SideBar itemSelected={"subkey4"} itemOpen={"sub2"}/>
        <Layout className="site-layout">
        <Header title={"New Loan Application"} subTitle={"Manage new loan application"}/>
          <Content style={{ margin: '0 100px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
              <Item>Loan Processing</Item>
              <Item>New Loan Application</Item>
            </Breadcrumb>
            <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
            <Tabs>
                <TabPane tab="Completed Loan Applications" key="1">
                    <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <p style={{fontSize: 15, fontWeight: 'bold', marginTop: 10, marginLeft: 10}}>Completed Loan Applications List</p>
                ...
                <TabPane tab="Incomplete Loan Applications" key="2">
                    <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <p style={{fontSize: 15, fontWeight: 'bold', marginTop: 10, marginLeft: 10}}>Incomplete Loan Applications List</p>
                        <Search placeholder="input search text" onSearch={() => {}} enterButton style={{width: '20vw'}} allowClear/>
                    </div>
