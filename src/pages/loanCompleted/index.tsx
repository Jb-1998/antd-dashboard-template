...
const LoanCompleted: FC<BaseProps> = () => {
    ...
    return  (
        ...
        <SideBar itemSelected={"subkey6"} itemOpen={"sub2"}/>
        <Layout className="site-layout">
        <Header title={"Completed Loans"} subTitle={"Manage all completed loan applications"}/>
          <Content style={{ margin: '0 100px' }}>
            <Breadcrumb style={{ margin: '16px 0' }}>
              <Item>Loan Processing</Item>
              <Item>Completed Loan Applications</Item>
            </Breadcrumb>
            <div className="site-layout-background" style={{ padding: 24, minHeight: 360 }}>
            <Tabs>
                <TabPane tab="Approved" key="1">
                    <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <p style={{fontSize: 15, fontWeight: 'bold', marginTop: 10, marginLeft: 10}}>Approved Applications</p>
                        <div style={{paddingRight: 10}}>
                            <Button onClick={onClose} icon={<DownloadOutlined />}   >
                                Download Approved List
                            </Button>
                            <Search placeholder="input search text" onSearch={() => {}} enterButton style={{width: '15vw', marginLeft: 5}} allowClear/>
                        </div>
                    </div>
                ...
                <TabPane tab="Rejected" key="2">
                    <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <p style={{fontSize: 15, fontWeight: 'bold', marginTop: 10, marginLeft: 10}}>Rejected Applications</p>
                        <div style={{paddingRight: 10}}>
                            <Button onClick={onClose} icon={<DownloadOutlined />}>
                ...
                <TabPane tab="For Resubmission" key="3">
                    <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center'}}>
                        <p style={{fontSize: 15, fontWeight: 'bold', marginTop: 10, marginLeft: 10}}>Applications for Resubmission</p>
                        <div style={{paddingRight: 10}}>
                            <Button onClick={onClose} icon={<DownloadOutlined />}>
                                Download For Resubmission List
                            </Button>
                            <Search placeholder="input search text" onSearch={() => {}} enterButton style={{width: '15vw', marginLeft: 5}} allowClear/>
                        </div>
                    </div>
